...
#ifndef __SAC_v29_H__
#define __SAC_v29_H__
...
class SAC : public HL7Segment {
 ...
 private:
  void init() {
    ...
    addObject<ST>(SAC_6, "SAC.6", HL7::initialized, HL7::repetition_off);
    ...
    addObject<CQ>(SAC_45, "SAC.45", HL7::initialized, HL7::repetition_off);
    addObject<CQ>(SAC_46, "SAC.46", HL7::initialized, HL7::repetition_off);
    addObject<CWE>(SAC_47, "SAC.47", HL7::initialized, HL7::repetition_off);
    addObject<CWE>(SAC_48, "SAC.48", HL7::initialized, HL7::repetition_off);
    addObject<CWE>(SAC_49, "SAC.49", HL7::initialized, HL7::repetition_off);
  }
 ...
 public:
  ...
  ST* getSAC_6(size_t index = 0) {
    return (ST*)this->getObjectSafe(index, SAC_6);
  }
  ...
  CQ* getSAC_45(size_t index = 0) {
    return (CQ*)this->getObjectSafe(index, SAC_45);
  }

  CQ* getContainerLength(size_t index = 0) {
    return (CQ*)this->getObjectSafe(index, SAC_45);
  }

  bool isSAC_45(size_t index = 0) {
    try {
      return this->getObject(index, SAC_45) != NULL;
    } catch (...) {
    }
    return false;
  }

  bool isContainerLength(size_t index = 0) {
    try {
      return this->getObject(index, SAC_45) != NULL;
    } catch (...) {
    }
  ...
  CQ* getSAC_46(size_t index = 0) {
    return (CQ*)this->getObjectSafe(index, SAC_46);
  }

  CQ* getContainerWidth(size_t index = 0) {
    return (CQ*)this->getObjectSafe(index, SAC_46);
  }

  bool isSAC_46(size_t index = 0) {
    try {
      return this->getObject(index, SAC_46) != NULL;
    } catch (...) {
    }
    return false;
  }

  bool isContainerWidth(size_t index = 0) {
    try {
      return this->getObject(index, SAC_46) != NULL;
    } catch (...) {
    }
  ...
  CWE* getSAC_47(size_t index = 0) {
    return (CWE*)this->getObjectSafe(index, SAC_47);
  }

  CWE* getContainerForm(size_t index = 0) {
    return (CWE*)this->getObjectSafe(index, SAC_47);
  }

  bool isSAC_47(size_t index = 0) {
    try {
      return this->getObject(index, SAC_47) != NULL;
    } catch (...) {
    }
    return false;
  }

  bool isContainerForm(size_t index = 0) {
    try {
      return this->getObject(index, SAC_47) != NULL;
    } catch (...) {
    }
  ...
  CWE* getSAC_48(size_t index = 0) {
    return (CWE*)this->getObjectSafe(index, SAC_48);
  }

  CWE* getContainerMaterial(size_t index = 0) {
    return (CWE*)this->getObjectSafe(index, SAC_48);
  }

  bool isSAC_48(size_t index = 0) {
    try {
      return this->getObject(index, SAC_48) != NULL;
    } catch (...) {
    }
    return false;
  }

  bool isContainerMaterial(size_t index = 0) {
    try {
      return this->getObject(index, SAC_48) != NULL;
    } catch (...) {
    }
  ...
  CWE* getSAC_49(size_t index = 0) {
    return (CWE*)this->getObjectSafe(index, SAC_49);
  }

  CWE* getContainerCommonName(size_t index = 0) {
    return (CWE*)this->getObjectSafe(index, SAC_49);
  }

  bool isSAC_49(size_t index = 0) {
    try {
      return this->getObject(index, SAC_49) != NULL;
    } catch (...) {
    }
    return false;
  }

  bool isContainerCommonName(size_t index = 0) {
    try {
      return this->getObject(index, SAC_49) != NULL;
    } catch (...) {
    }
