...
#ifndef __FAC_v29_H__
#define __FAC_v29_H__
...
class FAC : public HL7Segment {
 ...
 private:
  void init() {
    ...
    addObject<ID>(FAC_2, "FAC.2", HL7::initialized, HL7::repetition_off);
    addObject<XAD>(FAC_3, "FAC.3", HL7::initialized, HL7::repetition_off);
    addObject<XTN>(FAC_4, "FAC.4", HL7::initialized, HL7::repetition_off);
    addObject<XCN>(FAC_5, "FAC.5", HL7::initialized, HL7::repetition_off);
    addObject<ST>(FAC_6, "FAC.6", HL7::initialized, HL7::repetition_off);
    addObject<XAD>(FAC_7, "FAC.7", HL7::initialized, HL7::repetition_off);
    addObject<XTN>(FAC_8, "FAC.8", HL7::initialized, HL7::repetition_off);
    addObject<XCN>(FAC_9, "FAC.9", HL7::initialized, HL7::repetition_off);
    addObject<ST>(FAC_10, "FAC.10", HL7::initialized, HL7::repetition_off);
    addObject<XAD>(FAC_11, "FAC.11", HL7::initialized, HL7::repetition_off);
    addObject<XTN>(FAC_12, "FAC.12", HL7::initialized, HL7::repetition_off);
  }
