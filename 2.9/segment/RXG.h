...
#ifndef __RXG_v29_H__
#define __RXG_v29_H__
...
class RXG : public HL7Segment {
 ...
 private:
  void init() {
    ...
    addObject<ST>(RXG_3, "RXG.3", HL7::initialized, HL7::repetition_off);
    ...
    addObject<ST>(RXG_11, "RXG.11", HL7::initialized, HL7::repetition_off);
 ...
 public:
  ...
  ST* getRXG_3(size_t index = 0) {
    return (ST*)this->getObjectSafe(index, RXG_3);
  }
  ...
  ST* getRXG_11(size_t index = 0) {
    return (ST*)this->getObjectSafe(index, RXG_11);
  }
