...
#ifndef __XAD_v281_H__
#define __XAD_v281_H__
...
class XAD : public HL7Data {
 ...
 private:
  void init() {
    ...
    addObject<ST>(XAD_12, "XAD.12", HL7::initialized, HL7::repetition_off);
 ...
 public:
   ...
   */
  ST *getXAD_12(size_t index = 0) {
    return (ST *)this->getObjectSafe(index, XAD_12);
  }

  ST *getAddressValidityRange(size_t index = 0) {
    return (ST *)this->getObjectSafe(index, XAD_12);
  }
