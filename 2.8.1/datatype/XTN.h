...
#ifndef __XTN_v281_H__
#define __XTN_v281_H__
...
class XTN : public HL7Data {
 ...
 private:
  /* Field ID */
  enum FIELD_ID {
    XTN_1, /* Telephone Number */
    XTN_2, /* Telecommunication Use Code */
    XTN_3, /* Telecommunication Equipment Type */
    XTN_4, /* Communication Address */
    XTN_5, /* Country Code */
    XTN_6, /* Area/City Code */
    XTN_7, /* Local Number */
    XTN_8, /* Extension */
    XTN_9, /* Any Text */
    XTN_10, /* Extension Prefix */
    XTN_11, /* Speed Dial Code */
    XTN_12, /* Unformatted Telephone number */
    XTN_13, /* Effective Start Date */
    XTN_14, /* Expiration Date */
    XTN_15, /* Expiration Reason */
    XTN_16, /* Protection Code */
    XTN_17, /* Shared Telecommunication Identifier */
    XTN_18, /* Preference Order */
    FIELD_ID_MAX
  };
 ...
 private:
  void init() {
    setName("XTN");
    /* Init members */
    addObject<ST>(XTN_1, "XTN.1", HL7::initialized, HL7::repetition_off);
    ...
    addObject<SNM>(XTN_8, "XTN.8", HL7::initialized, HL7::repetition_off);
    ...
    addObject<ST>(XTN_12, "XTN.12", HL7::initialized, HL7::repetition_off);
    addObject<DTM>(XTN_13, "XTN.13", HL7::initialized, HL7::repetition_off);
    addObject<DTM>(XTN_14, "XTN.14", HL7::initialized, HL7::repetition_off);
    addObject<CWE>(XTN_15, "XTN.15", HL7::initialized, HL7::repetition_off);
    addObject<CWE>(XTN_16, "XTN.16", HL7::initialized, HL7::repetition_off);
    addObject<EI>(XTN_17, "XTN.17", HL7::initialized, HL7::repetition_off);
    addObject<NM>(XTN_18, "XTN.18", HL7::initialized, HL7::repetition_off);
  }
 ...
 public:
   ...
   * Telephone Number
   */
  ST *getXTN_1(size_t index = 0) {
    return (ST *)this->getObjectSafe(index, XTN_1);
  }

  ST *getTelephoneNumber(size_t index = 0) {
    return (ST *)this->getObjectSafe(index, XTN_1);
  }
  ...
  bool isTelephoneNumber(size_t index = 0) {
    try {
      return this->getObject(index, XTN_1) != NULL;
    } catch (...) {
    }
   ...
   * Extension
   */
  SNM *getXTN_8(size_t index = 0) {
    return (SNM *)this->getObjectSafe(index, XTN_8);
  }
   ...
   */
  ST *getXTN_12(size_t index = 0) {
    return (ST *)this->getObjectSafe(index, XTN_12);
  }
   ...
   * Expiration Date
   */
  DTM *getXTN_14(size_t index = 0) {
    return (DTM *)this->getObjectSafe(index, XTN_14);
  }
   ...
   * Protection Code
   */
  CWE *getXTN_16(size_t index = 0) {
    return (CWE *)this->getObjectSafe(index, XTN_16);
  }
   ...
   */
  EI *getXTN_17(size_t index = 0) {
    return (EI *)this->getObjectSafe(index, XTN_17);
  }
   ...
   * Preference Order
   */
  NM *getXTN_18(size_t index = 0) {
    return (NM *)this->getObjectSafe(index, XTN_18);
  }
  ...
  bool isXTN_18(size_t index = 0) {
    try {
      return this->getObject(index, XTN_18) != NULL;
    } catch (...) {
    }
    return false;
  }
