...
#ifndef __INV_v281_H__
#define __INV_v281_H__
...
class INV : public HL7Segment {
 ...
 private:
  void init() {
    ...
    addObject<NULLDT>(INV_14, "INV.14", HL7::initialized, HL7::repetition_off);
 ...
 public:
  ...
  NULLDT* getINV_14(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, INV_14);
  }

  NULLDT* getOnBoardStabilityDuration(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, INV_14);
  }
