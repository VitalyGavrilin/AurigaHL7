...
#ifndef __RXD_v281_H__
#define __RXD_v281_H__
...
class RXD : public HL7Segment {
 ...
 private:
  void init() {
    ...
    addObject<NULLDT>(RXD_13, "RXD.13", HL7::initialized, HL7::repetition_off);
 ...
 public:
  ...
  NULLDT* getRXD_13(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, RXD_13);
  }
