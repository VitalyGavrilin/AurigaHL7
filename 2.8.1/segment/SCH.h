...
#ifndef __SCH_v281_H__
#define __SCH_v281_H__
...
class SCH : public HL7Segment {
 ...
 private:
  void init() {
    ...
    addObject<EIP>(SCH_4, "SCH.4", HL7::initialized, HL7::repetition_off);
    ...
    addObject<NULLDT>(SCH_11, "SCH.11", HL7::initialized, HL7::repetition_off);
 ...
 public:
  ...
  EIP* getSCH_4(size_t index = 0) {
    return (EIP*)this->getObjectSafe(index, SCH_4);
  }
  ...
  NULLDT* getSCH_11(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, SCH_11);
  }

  NULLDT* getAppointmentTimingQuantity(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, SCH_11);
  }
