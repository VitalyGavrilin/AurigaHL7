...
#ifndef __GOL_v281_H__
#define __GOL_v281_H__
...
class GOL : public HL7Segment {
 ...
 private:
  void init() {
    ...
    addObject<NULLDT>(GOL_15, "GOL.15", HL7::initialized, HL7::repetition_off);
 ...
 public:
  ...
  NULLDT* getGOL_15(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, GOL_15);
  }

  NULLDT* getGoalReviewInterval(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, GOL_15);
  }
