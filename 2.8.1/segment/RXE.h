...
#ifndef __RXE_v281_H__
#define __RXE_v281_H__
...
class RXE : public HL7Segment {
 ...
 private:
  void init() {
    setName("RXE");
    /* Init members */
    addObject<NULLDT>(RXE_1, "RXE.1", HL7::initialized, HL7::repetition_off);
    ...
    addObject<NULLDT>(RXE_8, "RXE.8", HL7::initialized, HL7::repetition_off);
 ...
 public:
  ...
  NULLDT* getRXE_1(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, RXE_1);
  }
  ...
  NULLDT* getRXE_8(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, RXE_8);
  }
