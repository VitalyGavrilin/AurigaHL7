...
#ifndef __NK1_v281_H__
#define __NK1_v281_H__
...
class NK1 : public HL7Segment {
 ...
 public:
  ...
  XTN* getContactPersonsTelecommunicationInformation(size_t index = 0) {
    return (XTN*)this->getObjectSafe(index, NK1_41);
  }
  ...
  bool isContactPersonsTelecommunicationInformation(size_t index = 0) {
    try {
      return this->getObject(index, NK1_41) != NULL;
    } catch (...) {
    }
