...
#ifndef __OM1_v281_H__
#define __OM1_v281_H__
...
class OM1 : public HL7Segment {
 ...
 public:
  ...
  CWE* getOtherServiceTestObservationIDsfortheObservation(size_t index = 0) {
    return (CWE*)this->getObjectSafe(index, OM1_7);
  }
  ...
  ST* getPreferredShortNameorMnemonicfortheObservation(size_t index = 0) {
    return (ST*)this->getObjectSafe(index, OM1_10);
  }
  ...
  bool isPreferredShortNameorMnemonicfortheObservation(size_t index = 0) {
    try {
      return this->getObject(index, OM1_10) != NULL;
    } catch (...) {
    }
  ...
  CWE* getIdentityofInstrumentUsedtoPerformthisStudy(size_t index = 0) {
    return (CWE*)this->getObjectSafe(index, OM1_13);
  }
  ...
  DTM* getDateTimeStampforAnyChangeinDefinitionfortheObservation(size_t index = 0) {
    return (DTM*)this->getObjectSafe(index, OM1_21);
  }
  ...
  bool isDateTimeStampforAnyChangeinDefinitionfortheObservation(size_t index = 0) {
    try {
      return this->getObject(index, OM1_21) != NULL;
    } catch (...) {
    }
  ...
  CWE* getObservationsRequiredtoInterpretthisObservation(size_t index = 0) {
    return (CWE*)this->getObjectSafe(index, OM1_31);
  }
  ...
  bool isObservationsRequiredtoInterpretthisObservation(size_t index = 0) {
    try {
      return this->getObject(index, OM1_31) != NULL;
    } catch (...) {
    }
  ...
  ST* getOtherNamesNumber2(size_t index = 0) {
    return (ST*)this->getObjectSafe(index, OM1_51);
  }
  ...
  bool isOtherNamesNumber2(size_t index = 0) {
    try {
      return this->getObject(index, OM1_51) != NULL;
    } catch (...) {
    }
  ...
  CWE* getReplacementProducersServiceTestObservationID(size_t index = 0) {
    return (CWE*)this->getObjectSafe(index, OM1_52);
  }
  ...
  bool isReplacementProducersServiceTestObservationID(size_t index = 0) {
    try {
      return this->getObject(index, OM1_52) != NULL;
    } catch (...) {
    }
