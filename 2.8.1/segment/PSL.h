...
#ifndef __PSL_v281_H__
#define __PSL_v281_H__
...
class PSL : public HL7Segment {
 ...
 public:
  ...
  CP* getTotalAmountProfessionalPartTechnicalPart(size_t index = 0) {
    return (CP*)this->getObjectSafe(index, PSL_44);
  }
  ...
  bool isTotalAmountProfessionalPartTechnicalPart(size_t index = 0) {
    try {
      return this->getObject(index, PSL_44) != NULL;
    } catch (...) {
    }
