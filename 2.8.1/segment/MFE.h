...
#ifndef __MFE_v281_H__
#define __MFE_v281_H__
...
class MFE : public HL7Segment {
 ...
 private:
  void init() {
    ...
    addObject<Varies>(MFE_4, "MFE.4", HL7::initialized, HL7::repetition_off);
 ...
 public:
  ...
  Varies* getMFE_4(size_t index = 0) {
    return (Varies*)this->getObjectSafe(index, MFE_4);
  }

  Varies* getPrimaryKeyValueMFE(size_t index = 0) {
    return (Varies*)this->getObjectSafe(index, MFE_4);
  }
