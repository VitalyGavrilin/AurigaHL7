...
#ifndef __RXA_v281_H__
#define __RXA_v281_H__
...
class RXA : public HL7Segment {
 ...
 private:
  void init() {
    ...
    addObject<NULLDT>(RXA_11, "RXA.11", HL7::initialized, HL7::repetition_off);
 ...
 public:
  ...
  NULLDT* getRXA_11(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, RXA_11);
  }

  NULLDT* getAdministeredatLocation(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, RXA_11);
  }
