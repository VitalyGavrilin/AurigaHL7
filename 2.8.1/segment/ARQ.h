...
#ifndef __ARQ_v281_H__
#define __ARQ_v281_H__
...
class ARQ : public HL7Segment {
 ...
 private:
  void init() {
    ...
    addObject<EIP>(ARQ_4, "ARQ.4", HL7::initialized, HL7::repetition_off);
 ...
 public:
  ...
  EIP* getARQ_4(size_t index = 0) {
    return (EIP*)this->getObjectSafe(index, ARQ_4);
  }
