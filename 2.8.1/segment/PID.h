...
#ifndef __PID_v281_H__
#define __PID_v281_H__
...
class PID : public HL7Segment {
 ...
 private:
  void init() {
    ...
    addObject<NULLDT>(PID_2, "PID.2", HL7::initialized, HL7::repetition_off);
    addObject<CX>(PID_3, "PID.3", HL7::initialized, HL7::repetition_off);
    addObject<NULLDT>(PID_4, "PID.4", HL7::initialized, HL7::repetition_off);
    ...
    addObject<NULLDT>(PID_9, "PID.9", HL7::initialized, HL7::repetition_off);
    ...
    addObject<NULLDT>(PID_12, "PID.12", HL7::initialized, HL7::repetition_off);
    ...
    addObject<NULLDT>(PID_19, "PID.19", HL7::initialized, HL7::repetition_off);
    addObject<NULLDT>(PID_20, "PID.20", HL7::initialized, HL7::repetition_off);
 ...
 public:
  ...
  NULLDT* getPID_2(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, PID_2);
  }

  NULLDT* getPatientID(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, PID_2);
  }
  ...
  NULLDT* getPID_4(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, PID_4);
  }

  NULLDT* getAlternatePatientIDPID(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, PID_4);
  }
  ...
  NULLDT* getPID_9(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, PID_9);
  }

  NULLDT* getPatientAlias(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, PID_9);
  }
  ...
  NULLDT* getPID_12(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, PID_12);
  }

  NULLDT* getCountyCode(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, PID_12);
  }
  ...
  NULLDT* getPID_19(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, PID_19);
  }

  NULLDT* getSSNNumberPatient(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, PID_19);
  }
  ...
  NULLDT* getPID_20(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, PID_20);
  }

  NULLDT* getDriversLicenseNumberPatient(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, PID_20);
  }
