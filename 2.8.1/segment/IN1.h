...
#ifndef __IN1_v281_H__
#define __IN1_v281_H__
...
class IN1 : public HL7Segment {
 ...
 private:
  void init() {
    ...
    addObject<NULLDT>(IN1_38, "IN1.38", HL7::initialized, HL7::repetition_off);
    addObject<NM>(IN1_39, "IN1.39", HL7::initialized, HL7::repetition_off);
    addObject<NULLDT>(IN1_40, "IN1.40", HL7::initialized, HL7::repetition_off);
    addObject<NULLDT>(IN1_41, "IN1.41", HL7::initialized, HL7::repetition_off);
 ...
 public:
  ...
  NULLDT* getIN1_38(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, IN1_38);
  }

  NULLDT* getPolicyLimitAmount(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, IN1_38);
  }
  ...
  NULLDT* getIN1_40(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, IN1_40);
  }

  NULLDT* getRoomRateSemiPrivate(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, IN1_40);
  }
  ...
  NULLDT* getIN1_41(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, IN1_41);
  }

  NULLDT* getRoomRatePrivate(size_t index = 0) {
    return (NULLDT*)this->getObjectSafe(index, IN1_41);
  }
